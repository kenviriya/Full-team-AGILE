...
1. Capture the invocation workspace root before repository discovery. Use its basename as `<workspace-name>` for `Features/<workspace-name>/<feature-id>/`; do not replace it with a selected child name.
